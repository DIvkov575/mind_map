...
- the effective parameter space is infinite-dimensional,
- typically a function space or space of measures.
Example:
- all continuous distributinos on \mathbb{R}
- all densities on $L_1$
- all CDFs satisfying stanard properties