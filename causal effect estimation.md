...
Also appears as a downstream step after explicit causal discovery (inferring the causal graph itself) — see [[TSA Causal Relationship Mining]] for a time-series-specific pipeline.
